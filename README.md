...
지역 간 매출 편차의 원인을 규명하고 **효율적인 지역 맞춤형 마케팅 전략을 제안하는 것**이다.
...
- 겨울을 제외하곤 silver색상의 선호도가 높음.
- black 색상도 여름, 겨울 선호 색상임.
- silver, black 상품에 신경써야 할 것으로 보임.

**노년층 구간의 색상 선호 분석** |

노년층에서 색 다양성이 크게 감소하고 특정색에 선호 색상이 크게 몰리는 추세임.
- 가을에 특히 두드러지는 특징이며 특정 색상으로 선호색이 집중되는 현상이 발생함.
- 여름과 겨울 또한 마찬가지이며 다른 나이대에 비해 선호 색상 집중이 확연함.
- 노년층의 선호색상을 빠르게 파악하여 해당 색깔에 집중하는 편이 유리할 것으로 보임.
